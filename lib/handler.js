...
const get_valhalla_content_type = valhalla_type => "application/vnd.valhalla." + valhalla_type + "+json";
...
Handler.prototype.sendJSON = function (result, statusCode, valhalla_type) {
    if (result instanceof Error) {
        return this.handleError(result);
    }

    if (valhalla_type && this.accepts_json) {
        this.res.setHeader('Content-Type', get_valhalla_content_type(valhalla_type));
    }
