...
const ifs_map = {
    ...
    "access" : {
        ".bilrost\\resources\\test.assembly" : () => Promise.resolve(),
        ".bilrost/resources/test.assembly" : () => Promise.resolve(),
        ".bilrost\\resources\\test\\test.assembly" : () => Promise.resolve(),
        ".bilrost/resources/test/test.assembly" : () => Promise.resolve(),
        ".bilrost\\resources\\test\\test_001.assembly" : () => Promise.resolve(),
        ".bilrost/resources/test/test_001.assembly" : () => Promise.resolve(),
        ".bilrost\\resources\\mall\\mall_demo.assembly" : () => Promise.resolve(),
        ".bilrost/resources/mall/mall_demo.assembly" : () => Promise.resolve(),
        "test.assembly" : () => Promise.resolve(),
        "test/test.assembly" : () => Promise.resolve(),
        "test/test_001.assembly" : () => Promise.resolve(),
        "mall/mall_demo.assembly" : () => Promise.reject("can't be open")
    }
};
