...
describe('Github repo manager', function () {
    ...
    it('#branch_names #1', done => {
        const exec_by_line = (a, b, callback) => Promise.resolve([
            callback('  Push  URL: https://github.com/fl4re/bilrost.git'),
    ...
    it('#commit_log', done => {
        ...
        "Author: Maxime Helen <maxime.helen@starbreeze.com>               \n " +
    ...
    it('#project_id from ssh url https://github.com/fl4re/bilrost.git', done => {
        const log = '       git@github.com:fl4re/bilrost_s3_test_project.git          ';
        ...
        repo_manager
            .get_project_id()
            .then(project_id => {
                should.deepEqual(project_id, 'fl4re/bilrost_s3_test_project');
                done();
            })
            .catch(done);
    });
    ...
    it('#project_id from https url', done => {
        const log = '       https://github.com/fl4re/bilrost.git          ';
        ...
        repo_manager
            .get_project_id()
            .then(project_id => {
                should.deepEqual(project_id, 'fl4re/bilrost');
                done();
            })
            .catch(done);
    });
