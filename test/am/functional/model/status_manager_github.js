...
const level_1_0_0 = {
    ...
    "comment": "",
    "tag": [],
    "entryPoint": "resources/test.assembly",
    "collection": [],
    "setting": []
};
...
const prefab_1_0_0 = {
    ...
    "comment": "",
    "tag": [],
    "entryPoint": "resources/prefab/test.assembly",
    "collection": [],
    "setting": []
};
...
const prefab_1_1_0 = {
    ...
    "dependencies": [
        "/resources/test/prefab/test.assembly"
    ],
    "semantics": []
};
...
const asset_invalid_path = {
    ...
    "comment": "",
    "tags": [],
    "main": "/resources/invalid_path.assembly",
    "dependencies": [
        "/resources/invalid_path.assembly"
    ],
    "semantics": []
};
    ...
    before("create fixtures", function(done) {
        ...
        exec("git init", {cwd: fixtures}, function (error, stdout, stderr) {
            if (error||stderr) {
                ...
                //resources
                fs.outputJsonSync(Path.join(fixtures, 'test.assembly'), {});
                fs.outputJsonSync(Path.join(fixtures, 'test/test.assembly'), {});
                fs.outputJsonSync(Path.join(fixtures, 'prefab/test.assembly'), {});
                fs.outputJsonSync(Path.join(fixtures, 'test/prefab/test.assembly'), {});
