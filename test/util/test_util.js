...
class Test_util {
    ...
    constructor (schema, branch) {
        ...
        this.svn_repo_name = 'workspace-dev-test';
        this.test_svn_url = 'https://svn.starbreeze.com/svn/workspace-dev-test/' + branch;
        this.git_ssh_url = 'git@github.com:StarbreezeStudios/cloud-test-project-2.git';
        this.eloise = {
            ...
            'stage': [],
            project: {
                full_name: 'StarbreezeStudios/cloud-test-project-2',
                host: 's3'
            }
        };

        this.project1_file = {
            'name': 'cloud-test-project-2',
            'organization': 'StarbreezeStudios',
            'version': '2.0.0',
            'full_name': 'StarbreezeStudios/cloud-test-project-2',
            'url': 'https://api.github.com/repos/StarbreezeStudios/cloud-test-project-2',
            'tags': [
                'Hello',
                'World'
            ],
            ...
            'host_url': 'https://svn.starbreeze.com/svn/workspace-dev-test/',
            'ssh_url': 'git@github.com:StarbreezeStudios/cloud-test-project-2.git',
            https_url: 'https://github.com/StarbreezeStudios/cloud-test-project-2.git',
        ...
        this.example_project = {
            ...
            branches_url: '/contentbrowser/projects/StarbreezeStudios/cloud-test-project-2/',
            resources_url: '/contentbrowser/projects/StarbreezeStudios/cloud-test-project-2/resources/',
            assets_url: '/contentbrowser/projects/StarbreezeStudios/cloud-test-project-2/assets/'
        };

        this.s3_example_project = {
            id: 62078801,
            name: 'bilrost_s3_test_project',
            full_name: 'fl4re/bilrost_s3_test_project',
            owner:
            {
                id: 9989934,
                login: 'fl4re',
            ...
            pushed_at: '2016-06-28T16:19:51Z',
            size: 0,
            url: 'https://api.github.com/repos/fl4re/bilrost_s3_test_project',
            ssh_url: 'git@github.com:fl4re/bilrost_s3_test_project.git',
            https_url: 'https://github.com/fl4re/bilrost_s3_test_project.git',
            permissions: { pull: true, push: true, admin: true },
            branches_url: '/contentbrowser/projects/fl4re/bilrost_s3_test_project/',
            resources_url: '/contentbrowser/projects/fl4re/bilrost_s3_test_project/resources/',
            assets_url: '/contentbrowser/projects/fl4re/bilrost_s3_test_project/assets/'
        };
    ...
    create_eloise_fixtures () {
        return promisify(fs.remove)(this.get_fixtures())
            ...
            .then(() => this.svn_checkout(this.test_svn_url));
    }
