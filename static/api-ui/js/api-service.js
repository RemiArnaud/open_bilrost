/* jshint undef: true, unused: false, jquery: true, browser: true */

"use strict";
// doc: https://github.com/fl4re/fl4re-engine/wiki/content-browser-api 
...
var ContentBrowserApiService = {
	...
	branches : function(project_full_name, branch_name, filter, paging) {
		let url = '/contentbrowser/projects/'+project_full_name+'/'+branch_name+filter_paging(filter, paging);
		return req_promise(url, {
            dataType: 'json',
			method : "GET",
		});
	...
	project_workspaces : function(workspace_guid_name, filter, paging) {
